            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Min age',
                        hintText: '${controller.minChildAge?.value ?? 0}',
                      ),
                      onChanged: (v) => controller.minChildAge?.value = int.tryParse(v) ?? 0,
                    ),
                  ),
                  SizedBox(width: 8.w),
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Max age',
                        hintText: '${controller.maxChildAge?.value ?? 18}',
                      ),
                      onChanged: (v) => controller.maxChildAge?.value = int.tryParse(v) ?? 18,
                    ),
                  ),
                ],
              ),
              ...
              Obx(
                () => Wrap(
                  spacing: 8,
                  runSpacing: 8,
                  children: controller.draftConditions
                      .map(
                        (condition) => InputChip(
                          label: Text(condition),
                          onDeleted: () => controller.removeDraftCondition(condition),
                        ),
                      )
                      .toList(),
                ),
              ...
              Obx(
                () => Wrap(
                  spacing: 8,
                  runSpacing: 8,
                  children: controller.draftInstructions
                      .map(
                        (instruction) => InputChip(
                          label: Text(instruction),
                          onDeleted: () => controller.removeDraftInstruction(instruction),
                        ),
                      )
                      .toList(),
                ),
